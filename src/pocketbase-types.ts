...
export type GameModeResponse<Texpand = unknown> = Required<GameModeRecord> & BaseSystemFields<Texpand>
...
export type LolPositionnementResponse<Texpand = unknown> = Required<LolPositionnementRecord> & BaseSystemFields<Texpand>
...
export type ValoAgentsResponse<Texpand = unknown> = Required<ValoAgentsRecord> & BaseSystemFields<Texpand>
export type ValoArmeResponse<Texpand = unknown> = Required<ValoArmeRecord> & BaseSystemFields<Texpand>
export type ValoMapResponse<Texpand = unknown> = Required<ValoMapRecord> & BaseSystemFields<Texpand>
export type ValoRankResponse<Texpand = unknown> = Required<ValoRankRecord> & BaseSystemFields<Texpand>
export type ValoReticuleResponse<Texpand = unknown> = Required<ValoReticuleRecord> & BaseSystemFields<Texpand>
export type ValoSkinResponse<Texpand = unknown> = Required<ValoSkinRecord> & BaseSystemFields<Texpand>
